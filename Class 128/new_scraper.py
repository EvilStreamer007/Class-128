...
# Webdriver
browser = webdriver.Chrome("C:/Users/LENOVO/Desktop/Whitehat Jr/Classes/Class 128/chromedriver_win32/chromedriver.exe")
...
def scrape_more_data(hyperlink):
    ...
    try:
        ...
        soup = BeautifulSoup(page.content, "html.parser") #parsing - fetching and changing data int o another format
        temp_list = []
...
# Call method
for index, row in planet_df_1.iterrows(): #ITTEROWS - itterate/pass data through the rows of the dataframe
